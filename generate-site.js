...
const lindisfarneSchoolReview = pageShell({
  ...
  body: `
    ...
    <section class="band compact-band"><div class="school-fee-panel"><div><div class="eyebrow">2026 Fee Schedule Summary</div><h2>2026 年國際學生費用摘要。</h2><p>Fees below are indicative summaries from the school fee schedules supplied for review. Families must rely on Lindisfarne's formal Letter of Offer, Written Agreement and latest official fee schedule before payment.</p></div><div class="school-fee-table"><table><thead><tr><th>Programme</th><th>Indicative tuition / school fee</th><th>Notes</th></tr></thead><tbody><tr><td>Long-term application fees</td><td>A$290 application fee; A$1,390 enrolment acceptance fee; A$1,390 refundable student bond</td><td>Non-refundable / refundable status follows the school's policy and offer documents.</td></tr><tr><td>Long-term annual total, K-Year 2</td><td>Approx. A$29,428</td><td>Tuition and levies summary from 2026 schedule.</td></tr><tr><td>Long-term annual total, Years 7-8</td><td>Approx. A$33,650</td><td>Stage 4 semester total listed as approx. A$16,825.</td></tr><tr><td>Long-term annual total, Years 11-12</td><td>Approx. A$36,754</td><td>NESA HSC Year 12 fee and subject/activity costs may apply.</td></tr><tr><td>Short-term study</td><td>Approx. A$820 per week tuition, Kindergarten-Year 11</td><td>Tourist visa / one full term schedule. Uniform levy and activity costs may apply.</td></tr><tr><td>Homestay / full board</td><td>A$440 per week for one full term; A$510 per week for less than one term</td><td>Years 7-12 only, subject to school and welfare arrangements.</td></tr></tbody></table></div><p class="school-fee-note">Other possible costs include OSHC, uniforms, bank transfer fees, excursions, camps, bus routes, airport transfer and late-night collection. All amounts are in Australian dollars and subject to school confirmation.</p></div></section>
