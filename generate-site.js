...
const insightsArticles = [
  {
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Northern Territory: OTC has contacted Study NT regarding the Study NT Education Agent Training Course and future NT destination/provider briefings. Study NT has acknowledged the registration and issued an account-verification route for OTC's training access.",
    ...
    bodyZh: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Northern Territory：已向 Study NT 發出請求，關注 Study NT Education Agent Training Course 及 Northern Territory 學校、VET / TAFE、ELICOS、高等教育路線更新。Study NT 已回覆並發出帳戶驗證路徑，OTC 將把該路線作為 NT agent training 的進展記錄。",
    ...
    sidebarCards: [
      ...
      ["NT progress", "Study NT account route", "Study NT 已發出 agent training account verification，登入細節僅作內部保存。", "active"],
      ...
      <div class="nsw-schools-zone" id="nsw-schools">
        ...
        <div class="nsw-school-card-grid nsw-school-series-grid">
          <article>
            ...
            <p>OTC has requested access to official state and territory agent briefings, school-sector webinars and education updates across Queensland, Victoria, Western Australia, South Australia, Northern Territory, Tasmania and ACT. Study NT has already issued an account-verification route for training access.</p>
