...
const othmHealthSocialCareBilingualSeries = pageShell({
  ...
  body: `
    ...
    <section class="page-hero health-series-hero"><div class="band"><div class="eyebrow">Overseas Publishing House · 2026 Editorial Proposal</div><h1>《OTHM 健康護理雙語精講》系列出版策劃</h1><p>OTHM Health & Social Care Bilingual Study Series：面向 Level 3 至 Level 7 健康與社會照護學習者的雙語學術教輔規劃，重點處理資格框架、專業術語、評核語言、英澳升學銜接及職業資格邊界之間的知識轉譯。</p><div class="actions"><a class="btn btn-primary" href="#health-series-books">查看五冊書目</a><a class="btn btn-secondary" href="/zh/insights/othm-health-social-care-bilingual-study-series-plan/">閱讀導報介紹</a><a class="btn btn-secondary" href="/australia/">澳洲健康路線</a></div></div></section>
    ...
    <section class="band" id="health-series-books">
      <div class="section-head compact-head">
        ...
        <h2>五冊書目矩陣：按層級、能力目標與升學用途分冊。</h2>
      </div>
      <div class="comparison-table-wrap">
        <table class="pathway-table">
          <thead><tr><th>冊次</th><th>層級 / 工作書名</th><th>學術與專業內容範圍</th><th>主要讀者</th><th>編輯優先級</th></tr></thead>
          <tbody>
            <tr><td>Book 1</td><td><strong>Level 3</strong><br>Foundation and Career Orientation</td><td>NHS / Medicare 基礎、健康與社會照護職業結構、Level 3 核心概念、基礎術語、評核任務入門與證據整理</td><td>新生、轉行者、家長</td><td><span class="pill">First launch</span></td></tr>
            <tr><td>Book 2</td><td><strong>Level 4</strong><br>Management Foundations</td><td>照護機構運作、人員協調、專業溝通、多元文化護理、assessment criteria 回應方式與案例分析</td><td>初級主管、Level 4 學生</td><td><span class="pill">Planned</span></td></tr>
            <tr><td>Book 3</td><td><strong>Level 5</strong><br>Practice, Quality and Systems</td><td>CQC 標準、品質管理、研究方法、心理健康、殘疾支援倫理、NDIS、CHC / HLT 體系與 Diploma of Nursing 邊界</td><td>Level 5 學生、澳洲路線讀者</td><td><span class="pill">Priority</span></td></tr>
            <tr><td>Book 4</td><td><strong>Level 6</strong><br>Academic Progression Bridge</td><td>文獻引用、政策分析、批判性思維、澳洲 Advanced Entry 文件準備、unit outline 與 learning outcome 對照</td><td>升學申請者</td><td><span class="pill">Planned</span></td></tr>
            <tr><td>Book 5</td><td><strong>Level 7</strong><br>Health Management and Master's Preparation</td><td>研究設計、health-system leadership、strategic management、碩士銜接、跨學科健康管理與管理經驗轉化</td><td>管理層、研究生申請者</td><td><span class="pill">Planned</span></td></tr>
          </tbody>
        </table>
      </div>
    </section>
