...
function writeHeraldSocialImage(article, locale = "en") {
  ...
  <text x="78" y="522" fill="#5d4d3c" font-family="'Noto Sans TC', Arial, sans-serif" font-size="25" font-weight="900">${isZh ? "海外督導 OTC · 留學導報文章" : "Overseas Tutorial Centre · Study Review Article"}</text>
  <text x="78" y="558" fill="#8b7560" font-family="'Noto Sans TC', Arial, sans-serif" font-size="18">Overseas Tutorial Centre Ltd · OTC Study Hub</text>
