...
const insightsArticles = [
  {
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Northern Territory: OTC has completed the Study NT Education Agent Training Course and holds a certificate of completion. This strengthens OTC's public training record for Northern Territory schools, VET/TAFE, ELICOS and pathway-route awareness.",
    ...
    bodyZh: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Northern Territory：OTC 已完成 Study NT Education Agent Training Course，並取得 completion certificate。此項記錄將作為 OTC 建立 Northern Territory 學校、VET / TAFE、ELICOS、高等教育與 pathway 路線理解能力的公開培訓證明之一。",
    ...
    sidebarCards: [
      ...
      ["NT completed", "Study NT certificate", "OTC 已完成 Study NT Education Agent Training Course，completion certificate 已公開存檔。", "certificate"],
      ...
      <div class="nsw-schools-zone" id="nsw-schools">
        ...
        <div class="nsw-school-card-grid nsw-school-series-grid">
          <article>
            ...
            <p>OTC has requested access to official state and territory agent briefings, school-sector webinars and education updates across Queensland, Victoria, Western Australia, South Australia, Northern Territory, Tasmania and ACT. Study NT training has now been completed, with the certificate filed publicly.</p>
