...
const chineseEntrance = pageShell({
  ...
  body: `
    ...
    <section class="band compact-band zh-route-updates-section">
      <div class="section-head compact-head">
        <div class="eyebrow">申請路線更新</div>
        <h2>近期可查詢的項目型申請入口</h2>
        <p>具體 provider、intake 或 pathway 項目不放在首頁第一屏，而集中在申請路線更新區，供已進入申請階段的學生和家長查閱。</p>
      </div>
      <div class="zh-tool-link-list zh-route-update-list">
        <a href="/zh/study-group-2026-applications/"><strong>Study Group 2026 中文申請頁</strong><span>2026 年 7-12 月 pathway、直入與國際路線初步評估。</span></a>
        <a href="/university-applications/"><strong>大學申請評估系統</strong><span>按國別、院校、學院、課程建立初步審核與文件清單。</span></a>
        <a href="/zh/insights/uk-aus-application-documents-checklist/"><strong>英澳申請文件清單</strong><span>適合申請前整理成績單、推薦信、個人陳述與補充材料。</span></a>
      </div>
    </section>
    ...
    <section class="band compact-band zh-site-guide-section">
      <div class="section-head compact-head">
        <div class="eyebrow">站點指南</div>
        <h2>中文站點指南</h2>
        <p>這裡整理 OTC 中文站已公開的主要入口，方便學生、家長、合作機構與客戶按服務類型快速查找相關頁面。</p>
      </div>
      <div class="index-grid zh-site-guide-grid">
