...
SOURCE = ROOT / "reports" / "OTC_Malaysia_Singapore_Thailand_Bilingual_Early_Years_Summer_Research_2026-05-29.csv"
OUT_DIR = ROOT / "reports" / "db"
JSON_OUT = OUT_DIR / "otc_malaysia_singapore_thailand_summer_alliance_2026-05-29.json"
SQLITE_OUT = OUT_DIR / "otc_malaysia_singapore_thailand_summer_alliance_2026-05-29.sqlite"
...
def write_json(rows: list[dict[str, str]]) -> None:
    ...
    payload = {
        "dataset": "OTC Malaysia Singapore Thailand summer and bilingual early-years research",
        "date": "2026-05-29",
        "records": rows,
    }
    ...
    with sqlite3.connect(SQLITE_OUT) as conn:
        conn.execute(
            ...
            CREATE TABLE summer_alliance_candidates (
                ...
                age_range TEXT,
                programme_type TEXT,
                residential_day_parent_child TEXT,
                dates_2026_or_next_available TEXT,
                fee_public_or_tbc TEXT,
                english_or_bilingual_requirement TEXT,
